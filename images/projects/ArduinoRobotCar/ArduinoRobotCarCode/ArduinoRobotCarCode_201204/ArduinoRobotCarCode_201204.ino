...
void loop()
{
    ...
    {
        analogWrite(motorsLeftPin, 100);  // turn on left motors
        analogWrite(motorsRightPin, 100); // turn on right motors
    }
    else
    {
        analogWrite(motorsLeftPin, LOW);
        analogWrite(motorsRightPin, LOW);
    }
}
